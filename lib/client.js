...
window.__ModuleLoader__.load({
	...
	factory: function (require) {
		...
		var TOOL_ICON_SVG = '<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3.5" y="1.5" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1" opacity="0.5"/><rect x="1.5" y="3.5" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1"/></svg>';
