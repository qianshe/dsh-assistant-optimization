...
// Loaded by the DSH browser module system via window.__ModuleLoader__.load().
// All plugin logic is client-side (no host RPC needed; markers persisted in localStorage).
window.__ModuleLoader__.load({
	...
	factory: function (require) {
		...
		function WrappedAssistantStep(props) {
			...
			// Listen for marker changes from settings page
